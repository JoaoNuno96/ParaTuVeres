...
export function navegacao(direccao)
{
    if(direccao == "home")
    {
        window.scroll({
...
export function navegacaoLateral(direccaoLateral)
{
...
export function registarFofoca()
{
...
export function receberFofocas()
{
    var arr = [];
...
//RELOAD PAGE
export function recarregarWindow()
{
    window.location.reload();
}

//RETORNAR PARA PAGINA INDEX EM NOTICIAS
export function retornarIndexNoticias()
{
